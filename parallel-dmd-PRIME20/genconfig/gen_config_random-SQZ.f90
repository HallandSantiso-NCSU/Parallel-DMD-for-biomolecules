		...
		integer nb,nb2,chnln,nc,nop,nop2
      ...
      parameter(nb=88)          ! number of beads
      parameter(nb2=84)         ! number of beads without glycines
      parameter(chnln=22)       ! chain length
      parameter(nc=12)           ! chain number	
      parameter(nop=nb*nc)      !total number of beads
      parameter(nop2=nb2*nc)    !total number of beads minus glycines
        integer nb3,nb4,chnln2,nc2,nop3,nop4
      parameter(nb3=88)          ! number of beads
      parameter(nb4=84)         ! number of beads without glycines
      parameter(chnln2=22)       ! chain length
      parameter(nc2=12)           ! chain number	
      parameter(nop3=nb3*nc2)      !total number of beads
      parameter(nop4=nb4*nc2)    !total number of beads minus glycines
