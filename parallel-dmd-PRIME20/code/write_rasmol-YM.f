             ...
             if (k .le. nop1/numbeads1) then 
			   ...
			   p = 0
				...
				n = (k-1)*numbeads1+1			  
                  ...
                  write(11113,7) 'ATOM',m  ,' N  ',amino_name,col(1),j,sv(1,n+chnln1),sv(2,n+chnln1),sv(3,n+chnln1)								
				  write(11113,7) 'ATOM',m+1,' CA ',amino_name,col(1),j,sv(1,n),sv(2,n),sv(3,n)					
				  write(11113,7) 'ATOM',m+2,' C  ',amino_name,col(1),j,sv(1,n+2*chnln1),sv(2,n+2*chnln1),sv(3,n+2*chnln1)				
   	  			if(j.ne.chnln1) then
   	  			...
   	  			rz1=SV(3,n+2*chnln1)+1.231d0/r1*rz1
   	  			  ...
   	  			  write(11113,7) 'ATOM',m+3,' O  ',amino_name,col(1),j,rx1,ry1,rz1								
							if (fside1(j).ne.0) then
								!new2_rx(m+3)=newrx2(n-p+3*chnln2)
				  write(11113,7) 'ATOM',m+4,' CB ',amino_name,col(1),j,sv(1,n-p+3*chnln1),sv(2,n-p+3*chnln1),sv(3,n-p+3*chnln1)
		    ...
		    !do k=1,nop2/numbeads2
			   ...
			   p = 0
				...
				n = nop1+(k-nop1/numbeads1-1)*(numbeads2)+1
                  ...
                  write(11113,7) 'ATOM',m  ,' N  ',amino_name,col(2),j,sv(1,n+chnln2),sv(2,n+chnln2),sv(3,n+chnln2)								
				  write(11113,7) 'ATOM',m+1,' CA ',amino_name,col(2),j,sv(1,n),sv(2,n),sv(3,n)					
				  write(11113,7) 'ATOM',m+2,' C  ',amino_name,col(2),j,sv(1,n+2*chnln2),sv(2,n+2*chnln2),sv(3,n+2*chnln2)				
   	  			if(j.ne.chnln2) then
   	  			...
   	  			rz1=SV(3,n+2*chnln2)+1.231d0/r1*rz1
   	  			  ...
   	  			  write(11113,7) 'ATOM',m+3,' O  ',amino_name,col(2),j,rx1,ry1,rz1

				  
							if (fside2(j).ne.0) then
								!new2_rx(m+3)=newrx2(n-p+3*chnln2)
				  write(11113,7) 'ATOM',m+4,' CB ',amino_name,col(2),j,sv(1,n-p+3*chnln2),sv(2,n-p+3*chnln2),sv(3,n-p+3*chnln2)
