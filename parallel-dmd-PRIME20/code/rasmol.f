    	...
    	do chainn=1, (numchains)-(nop2/numbeads2)
           	...
           	do i = (chainn-1)*numbeads1+1, chainn*numbeads1
	      		...
	      		if (identity(i) .gt. 8) then
	         		write(11113,'(a6,i5,a3,1x,15x,3f8.3)') 'ATOM  ',i,col(1),sv(1,i),sv(2,i),sv(3,i)
			endif
	      		if (ii==3*chnln1) then
	         		write(11113,'(a6,i5,a3,1x,15x,3f8.3)') 'ATOM  ',i,'S',sv(1,i),sv(2,i),sv(3,i)
			endif
			if (identity(i) .le. 8) then
	         		write(11113,'(a6,i5,a3,1x,15x,3f8.3)') 'ATOM  ',i,col(2),sv(1,i),sv(2,i),sv(3,i)
	      		end if
	     	end do	
  	end do
