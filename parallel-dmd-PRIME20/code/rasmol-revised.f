   	  	...
   	  	do i=1,nop1,numbeads1
				...
				k4=k4+1  
                                if(fside1(j).ne.0) then
                                        ...
                                        if(identity(fside1(j)).eq.22) amino_name='LLE'
   	  	     		...
   	  	     		write(11113,7) 'ATOM',k4,' N  ',amino_name,col(chnnum(i)),j,sv(1,i-1+j+chnln1),sv(2,i-1+j+chnln1),sv(3,i-1+j+chnln1)
                                !print *, 'N',i-1+j+chnln1,sv(1,i-1+j+chnln1),sv(2,i-1+j+chnln1),sv(3,i-1+j+chnln1)
				k4=k4+1
		      		write(11113,7) 'ATOM',k4,' CA ',amino_name,col(chnnum(i)),j,sv(1,i-1+j),sv(2,i-1+j),sv(3,i-1+j)
                                !print *, 'C',i-1+j,sv(1,i-1+j),sv(2,i-1+j),sv(3,i-1+j)
				k4=k4+1
		      		write(11113,7) 'ATOM',k4,' C  ',amino_name,col(chnnum(i)),j,sv(1,i-1+j+2*chnln1),sv(2,i-1+j+2*chnln1),sv(3,i-1+j+2*chnln1)
   	  			if(j.ne.chnln1) then
				...
				k4=k4+1
   	  			write(11113,7) 'ATOM',k4,' O  ',amino_name,col(chnnum(i)),j,rx1,ry1,rz1
				if(fside1(j).ne.0) then	
					k4=k4+1
                                       m = floor((j+2)/5.0d0)+floor(j/5.0d0)
		      			write(11113,7) 'ATOM',k4,' CB ',amino_name,col(chnnum(i)),j,sv(1,i-1+j+3*chnln1-m),sv(2,i-1+j+3*chnln1-m),sv(3,i-1+j+3*chnln1-m)
				endif
	     		enddo
		enddo
   	  	...
   	  	do i=nop1+1,nop1+nop2,numbeads2
				...
				k4=k4+1  
                                if(fside2(j).ne.0) then
                                        ...
                                        if(identity(fside2(j)).eq.22) amino_name='LLE'
   	  	     		...
   	  	     		write(11113,7) 'ATOM',k4,' N  ',amino_name,col(chnnum(i)-nop1/chnln1),j,sv(1,i-1+j+chnln2),sv(2,i-1+j+chnln2),sv(3,i-1+j+chnln2)
                                !print *, 'N',i-1+j+chnln2,sv(1,i-1+j+chnln2),sv(2,i-1+j+chnln2),sv(3,i-1+j+chnln2)
				k4=k4+1
		      		write(11113,7) 'ATOM',k4,' CA ',amino_name,col(chnnum(i)-nop1/chnln1),j,sv(1,i-1+j),sv(2,i-1+j),sv(3,i-1+j)
                                !print *, 'C',i-1+j,sv(1,i-1+j),sv(2,i-1+j),sv(3,i-1+j)
				k4=k4+1
		      		write(11113,7) 'ATOM',k4,' C  ',amino_name,col(chnnum(i)-nop1/chnln1),j,sv(1,i-1+j+2*chnln2),sv(2,i-1+j+2*chnln2),sv(3,i-1+j+2*chnln2)
   	  			if(j.ne.chnln2) then
				...
				k4=k4+1
   	  			write(11113,7) 'ATOM',k4,' O  ',amino_name,col(chnnum(i)-nop1/chnln1),j,rx1,ry1,rz1
				if(fside2(j).ne.0) then	
					k4=k4+1
                                       m = floor((j+2)/5.0d0)+floor(j/5.0d0)
		      			write(11113,7) 'ATOM',k4,' CB ',amino_name,col(chnnum(i)-nop1/chnln1),j,sv(1,i-1+j+3*chnln2-m),sv(2,i-1+j+3*chnln2-m),sv(3,i-1+j+3*chnln2-m)
				endif
	     		enddo
		enddo
...
!		    write(11113,'(A6,I5,I5)') 'CONECT', i, j
!	         END IF
!	      END IF
!	   end do
!	end do
