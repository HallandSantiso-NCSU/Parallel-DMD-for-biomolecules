...
!	based on i,j pair also generates ev_param file (column 1: "factor", 
!	column 2: "blmin", and column 3: "blmax")
...
!    	ev_code = 12: r_i to c_i (pseudobond) 
  	ev_param(2,4)=dnc*(1.d0-del)/boxl_orig
     	ev_param(2,5)=dcc*(1.d0-del)/boxl_orig
 	ev_param(2,6)=dcn*(1.d0-del)/boxl_orig
  	ev_param(2,7)=dtie*(1.d0-del)/boxl_orig
  	ev_param(2,8)=dtie2*(1.d0-del)/boxl_orig
    	ev_param(2,9)=dcaca*(1.d0-del)/boxl_orig
